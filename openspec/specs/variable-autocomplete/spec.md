...
Variable autocomplete capability for triggering suggestion popups when the user types `{{` in input fields, showing matching variables with scope annotations.
