...
Global variables capability for defining key-value pairs that apply to all requests regardless of environment or collection context, with lowest priority in variable resolution.
